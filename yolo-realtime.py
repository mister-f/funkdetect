...
''' 
Capture webcam stream (0 index if first found system webcam)
If the wrong video source is being obtained this index can be changed.
'''
video_stream = cv2.VideoCapture(0)

# Infinite while loop to continuously capture webcam images
while True:
...
# Release webcam and close open image window    
